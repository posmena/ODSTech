...
var list_tabs = new dbxGroup(
	'list_tabs', 			// container ID [/-_a-zA-Z0-9/]
...
manager.onstatechange = function()
{
	...
	$.get("/manage/tabs", { type: "ajax", func: "save_settings", list_sort: $('#list_sort').val() },
	    function(data){
			//$('#m00').html(data);						
	});
    return true;
...
$(document).ready(function(){
	$('a.remove_tab').each(function(){
		$(this).click(function(){
			var tab_id = $(this).attr('href');
			$.get("/manage/tabs", { type: "ajax", func: "remove_tab", tab_id: tab_id },
			function(data){
				$('#listtab'+tab_id).hide('fast');
			});
			return false;
		});	
	});
