...
<link href="http://odst.co.uk/api/hilton/styles.css" rel="stylesheet" type="text/css" />
<!--[if IE]>
<link rel="stylesheet" type="text/css" href="http://odst.co.uk/api/hilton/ieStyles.css" />
<![endif]--><link href="http://odst.co.uk/api/hilton/jquery-ui-1.8.23.custom.css" rel="stylesheet" type="text/css" />
<link href="http://odst.co.uk/api/hilton/sayt.css" rel="stylesheet" type="text/css" />
<script src="http://odst.co.uk/api/hilton/js/jquery-1.8.0.min.js" type="text/javascript" /></script>
<script src="http://odst.co.uk/api/hilton/js/jquery-ui-1.8.23.custom.min.js" type="text/javascript"></script>
<script src="http://odst.co.uk/api/hilton/js/odst_hilton.js" type="text/javascript"></script>
...
{
?>
	<table class="odst_reset odst_hilton_1" width="160" height="600" border="0" cellspacing="0"  >
		<tr>
			<td align="left" valign="middle" style="vertical-align:middle" background="http://odst.co.uk/api/hilton/images/160x600back.jpg" style="padding:10px">
				<table style="padding-left:6px" class="odst_reset odst_hilton_1"  border="0" table="table" width="140" height="250" cellspacing="0" cellpadding="0" class="vstyle" >
					<tr>
						<td>
							<label for="city" style="margin-bottom:5px; display:inline-block;">WHERE ARE YOU GOING?</label>
							<br />   
							<span class="odt_spanTextInput">
								<input onfocus="searchAsYouType.initialize(this, false);" id="odst_locationTextInput" type="text" value="City, airport, address, attraction, or hotel" maxlength="100" autocomplete="off" style="width:125px;"/>
							</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							...
							<span class="odt_spanTextInput" dir="ltr">
								<input type="text" id="from" value="16 Nov 2012" name="arrivalDate" >
					...
					<tr>
						<td> 
							...
							<br/>
							<span class="odt_spanTextInput" dir="ltr">
								<input type="text" id="to" value="18 Nov 2012" name="departureDate" >
					...
					<tr>
						<td>
							<a href="#" class="odst_findbutton" title="Find it" role="button">
...
<table class="odst_reset odst_hilton_1" width="120" height="600" border="0" cellspacing="0"  >
		<tr>
			<td align="left" valign="middle"  style="vertical-align:middle" background="http://odst.co.uk/api/hilton/images/120x600back.jpg" style="padding:10px">
				<table style="padding-left:6px" class="odst_reset odst_hilton_1" border="0" table="table" width="100" height="270" cellspacing="0" cellpadding="0" class="vstyle">
					<tr>
						<td>
							<label for="city" style="margin-bottom:5px; display:inline-block;">WHERE ARE YOU GOING?</label>
							<br />   
							<span class="odt_spanTextInput">
								<input onfocus="searchAsYouType.initialize(this, false);" id="odst_locationTextInput" type="text" value="City, airport, address, attraction, or hotel" maxlength="100" autocomplete="off" style="width:90px;"/>
							</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							...
							<br/>
							<span class="odt_spanTextInput" dir="ltr">
								<input type="text" id="from" value="15 Nov 2012" name="arrivalDate" style="width: 80px!important" >
								<span id="arrivalPopupInstruction" style="display:none;">You are now focused on a datepicker field. Press the down arrow to enter the calendar table. Once focused on the table, press left or right to navigate days. Press up or down to navigate between weeks. Enter to select. Escape to close datepicker. Your arrival date must be within the next year.</span>
							</span>
						</td>
					</tr>
					<tr>
						<td> 
							...
							<br/>
							<span class="odt_spanTextInput" dir="ltr">
								<input type="text" id="to" value="18 Nov 2012" name="departureDate" style="width: 80px!important" >
								<span id="departurePopupInstruction" style="display:none;">You are now focused on a datepicker field. Press the down arrow to enter the calendar table. Once focused on the table, press left or right to navigate days. Press up or down to navigate between weeks. Enter to select. Escape to close datepicker. Your departure date must be within 4 months after your arrival date.</span>
							</span> 
						</td>
					</tr>
					<tr>
						<td>
							<a href="#" class="odst_findbutton" title="Find it" role="button" style="margin-top:5px;">
								<span class="odst_text" >Find it</span>
								<span class="arrow_icon">&nbsp;</span>
							</a>
						</td>
...
<table class="odst_reset odst_hilton_1" width="460" height="125" border="0" cellspacing="0"  >
		<tr>
			<td align="right" valign="bottom" background="http://odst.co.uk/api/hilton/images/460x125back.jpg" style="padding:10px">
				<table style="padding-left:6px" valign="top" class="odst_reset odst_hilton_1" border="0" table="table" width="320" height="50" cellspacing="0" cellpadding="0" class="vstyle" style="text-align: left;">
					<tr>
						<td>
							<label for="city" style="margin-bottom:5px; display:inline-block;">WHERE ARE YOU GOING?</label>
							<br />   
							<span class="odt_spanTextInput">
								<input onfocus="searchAsYouType.initialize(this, false);"  id="odst_locationTextInput" type="text" value="City, airport, address, attraction, or hotel" maxlength="100" autocomplete="off" style="width:320px;"/>
							</span>
						</td>
					</tr>
				</table>
				<table style="padding-left:6px" class="odst_reset odst_hilton_1" valign="bottom" border="0" table="table" width="320" height="50" cellspacing="0" cellpadding="0" class="vstyle" >
					<tr>
						...
						<td width="101px" align="left">
							...
							<br/>
							<span class="odt_spanTextInput" dir="ltr">
								<input type="text" id="from" value="15 Nov 2012" name="arrivalDate" >
								<span id="arrivalPopupInstruction" style="display:none;">You are now focused on a datepicker field. Press the down arrow to enter the calendar table. Once focused on the table, press left or right to navigate days. Press up or down to navigate between weeks. Enter to select. Escape to close datepicker. Your arrival date must be within the next year.</span>
							</span>
						</td>
						...
						<td align="right">
							<a href="#" class="odst_findbutton" title="Find it" role="button" style="margin-top:20px;">
								<span class="odst_text" >Find it</span>
...
{
?>	
<table class="odst_reset odst_hilton_1" width="728" height="90" border="0" cellspacing="0"  >
		<tr>
			<td align="right" valign="top" background="http://odst.co.uk/api/hilton/images/728x90back.jpg">
				<table style="padding-left:6px" class="odst_reset odst_hilton_1" border="0" table="table" width="440" height"45" cellspacing="0" cellpadding="0" class="vstyle" style="text-align: left;">
					<tr>
						<td>
							<label for="city" style="margin-bottom:5px; text-align: left; display:inline-block;">WHERE ARE YOU GOING?</label>
							<br />   
							<span class="odt_spanTextInput">
								<input onfocus="searchAsYouType.initialize(this, false);"  id="odst_locationTextInput" type="text" value="City, airport, address, attraction, or hotel" maxlength="100" autocomplete="off" style="width:350px;"/>
							</span>
						</td>
				...
				<table class="odst_reset odst_hilton_1" border="0" table="table" width="440" cellspacing="0" cellpadding="0" class="vstyle" height=30">
					<tr valign="bottom">
						<td valign="middle" style="vertical-align:middle" width="178" align="left">
						...
						<td valign="middle" style="vertical-align:middle" align="left" width="84">
							<a href="#" class="odst_findbutton" title="Find it" role="button" style="margin-top:3px;">
...
{
?>
<table class="odst_reset odst_hilton_1" width="300" height="250" border="0" cellpadding="8" cellspacing="0"  >
		<tr>
			<td align="left" valign="bottom" background="http://odst.co.uk/api/hilton/images/300x250back.jpg" style="padding:10px">
				<table class="odst_reset odst_hilton_1" border="0" table="table" width="280" height="46" cellspacing="0" cellpadding="0" class="vstyle" >
					<tr>
						<td>
							<label for="city" style="margin-bottom:5px; display:inline-block;">WHERE ARE YOU GOING?</label>
							<br />   
							<span class="odt_spanTextInput">
								<input onfocus="searchAsYouType.initialize(this, false);"  id="odst_locationTextInput" type="text" value="City, airport, address, attraction, or hotel" maxlength="100" autocomplete="off" style="width:270px;"/>
							
							</span>
						</td>
					</tr>
				</table>
				<table class="odst_reset odst_hilton_1" border="0" table="table" width="280" height="92" cellspacing="0" cellpadding="0" class="vstyle" >
					<tr>
						<td>
							<label for="checkin" class="labelTop arrival" style="margin-bottom: 7px; display: inline-block;">Arrival</label>
							<br/>
