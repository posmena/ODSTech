var searchAsYouTypeConfiguration =  {
    // The path (beginning of the URL) to the place containing /http://odstest.co.uk/api/hilton/images and
...
SearchAsYouType.prototype.initializeVariables_ = function(inputFieldEl) {
  ...
  // Path (URL beginning) to resources such as http://odstest.co.uk/api/hilton/images or CSS files
...
SearchAsYouType.prototype.createDomElements_ = function() {
  ...
  this.waitingForSearchResultsEl.src = 
    this.resourcesPath + "http://odstest.co.uk/api/hilton/images/loading.gif";
...
SearchAsYouType.prototype.showResultsWindow_ = function() {
  ...
  // We go through all of the http://odstest.co.uk/api/hilton/images, hide them, and assign the function
...
/**
 * Show the image after it's loaded. Prevents http://odstest.co.uk/api/hilton/images loading and layout
...
document.write('<link href="http://odstest.co.uk/api/hilton/styles.css" rel="stylesheet" type="text/css" />');
document.write('<!--[if IE]>');
document.write('<link rel="stylesheet" type="text/css" href="http://odstest.co.uk/api/hilton/ieStyles.css" />');
document.write('<![endif]--><link href="http://odstest.co.uk/api/hilton/jquery-ui-1.8.23.custom.css" rel="stylesheet" type="text/css" />');
document.write('<link href="http://odstest.co.uk/api/hilton/sayt.css" rel="stylesheet" type="text/css" />');
document.write('<script src="http://odstest.co.uk/api/hilton/js/jquery-1.8.0.min.js" type="text/javascript" /></script>');
document.write('<script src="http://odstest.co.uk/api/hilton/js/jquery-ui-1.8.23.custom.min.js" type="text/javascript"></script>');
document.write('<script src="http://odstest.co.uk/api/hilton/js/odst_hilton.js" type="text/javascript"></script>');
document.write('');
...
document.write('		<tr>');
document.write('			<td align="left" valign="middle" style="vertical-align:middle" background="http://odstest.co.uk/api/hilton/images/160x600back.jpg" style="padding:10px">');
...
document.write('								<label class="labelOneBoxHint" for="hotelSearchOneBox" style="display:inline;" >City, address...</label>');
document.write('								<input onfocus="searchAsYouType.initialize(this, false);" id="odst_locationTextInput" type="text" value="" maxlength="100" autocomplete="off" style="width:125px;"/>');
document.write('							</span>');
document.write('						</td>');
document.write('					</tr>');
document.write('					<tr>');
...
document.write('								<input type="text" id="from" value="16 Nov 2012" name="arrivalDate" >');
...
document.write('							<br/>');
document.write('							<span class="odt_spanTextInput" dir="ltr">');
document.write('								<input type="text" id="to" value="18 Nov 2012" name="departureDate" >');
...
document.write('		<tr>');
document.write('			<td align="left" valign="middle"  style="vertical-align:middle" background="http://odstest.co.uk/api/hilton/images/120x600back.jpg" style="padding:10px">');
...
document.write('							<span class="odt_spanTextInput">');
document.write('								<label class="labelOneBoxHint" for="hotelSearchOneBox" style="display:inline;" >City, address...</label>');
document.write('								<input onfocus="searchAsYouType.initialize(this, false);" id="odst_locationTextInput" type="text" value="" maxlength="100" autocomplete="off" style="width:90px;"/>');
document.write('							</span>');
document.write('						</td>');
document.write('					</tr>');
document.write('					<tr>');
...
document.write('							<br/>');
document.write('							<span class="odt_spanTextInput" dir="ltr">');
document.write('								<input type="text" id="from" value="15 Nov 2012" name="arrivalDate" style="width: 80px!important" >');
document.write('								<span id="arrivalPopupInstruction" style="display:none;">You are now focused on a datepicker field. Press the down arrow to enter the calendar table. Once focused on the table, press left or right to navigate days. Press up or down to navigate between weeks. Enter to select. Escape to close datepicker. Your arrival date must be within the next year.</span>');
document.write('							</span>');
document.write('						</td>');
document.write('					</tr>');
...
document.write('							<br/>');
document.write('							<span class="odt_spanTextInput" dir="ltr">');
document.write('								<input type="text" id="to" value="18 Nov 2012" name="departureDate" style="width: 80px!important" >');
document.write('								<span id="departurePopupInstruction" style="display:none;">You are now focused on a datepicker field. Press the down arrow to enter the calendar table. Once focused on the table, press left or right to navigate days. Press up or down to navigate between weeks. Enter to select. Escape to close datepicker. Your departure date must be within 4 months after your arrival date.</span>');
document.write('							</span> ');
document.write('						</td>');
document.write('					</tr>');
...
document.write('		<tr>');
document.write('			<td align="right" valign="bottom" background="http://odstest.co.uk/api/hilton/images/460x125back.jpg" style="padding:10px">');
...
document.write('							<br />   ');
document.write('							<span class="odt_spanTextInput">');
document.write('								<label class="labelOneBoxHint" for="hotelSearchOneBox" style="display:inline;" >City, airport, address, attraction, or hotel</label>');
document.write('								<input onfocus="searchAsYouType.initialize(this, false);"  id="odst_locationTextInput" type="text" value="" maxlength="100" autocomplete="off" style="width:320px;"/>');
document.write('							</span>');
document.write('						</td>');
document.write('					</tr>');
document.write('				</table>');
...
document.write('							<br/>');
document.write('							<span class="odt_spanTextInput" dir="ltr">');
document.write('								<input type="text" id="from" value="15 Nov 2012" name="arrivalDate" >');
document.write('								<span id="arrivalPopupInstruction" style="display:none;">You are now focused on a datepicker field. Press the down arrow to enter the calendar table. Once focused on the table, press left or right to navigate days. Press up or down to navigate between weeks. Enter to select. Escape to close datepicker. Your arrival date must be within the next year.</span>');
document.write('							</span>');
document.write('						</td>');
document.write('						');
...
document.write('		<tr>');
document.write('			<td align="right" valign="top" background="http://odstest.co.uk/api/hilton/images/728x90back.jpg">');
...
document.write('							<span class="odt_spanTextInput">');
document.write('								<label class="labelOneBoxHint" for="hotelSearchOneBox" style="display:inline;" >City, airport, address, attraction, or hotel</label>');
document.write('								<input onfocus="searchAsYouType.initialize(this, false);"  id="odst_locationTextInput" type="text" value="" maxlength="100" autocomplete="off" style="width:350px;"/>');
document.write('							</span>');
document.write('						</td>');
...
document.write('		<tr>');
document.write('			<td align="left" valign="bottom" background="http://odstest.co.uk/api/hilton/images/300x250back.jpg" style="padding:10px">');
...
document.write('							<span class="odt_spanTextInput">');
document.write('								<label class="labelOneBoxHint" for="hotelSearchOneBox" style="display:inline;" >City, airport, address, attraction, or hotel</label>');
document.write('								<input onfocus="searchAsYouType.initialize(this, false);"  id="odst_locationTextInput" type="text" value="" maxlength="100" autocomplete="off" style="width:270px;"/>');
document.write('							');
document.write('							</span>');
document.write('						</td>');
document.write('					</tr>');
