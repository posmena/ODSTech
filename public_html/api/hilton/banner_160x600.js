...
document.write('');
document.write('<form id="frm_odst_hilton" method="POST" action="http://www3.hilton.com/en_US/hi/search/findhotels/index.htm">');
...
document.write('		<tr>');
document.write('			<td align="left" valign="middle" background="http://odstest.co.uk/api/hilton/images/160x600back.jpg" style="padding:10px">');
document.write('				<table class="odst"  border="0" table="table" width="140" height="250" cellspacing="0" cellpadding="0" class="vstyle" >');
document.write('					<tr>');
document.write('						<td>');
