...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="livingsocial_banner_728x90.css" />   
...
<div style="width:728px; height:90px; position:relative;">
    <div class="arrownav" style="position:absolute; right:0px; top:0px; z-index:100;">
		<a href="#" class="PreviousDealLink"><img class="previous" alt="previous" src="728x90/previous.gif" /></a><a href="#" class="NextDealLink"><img class="next" alt="next" src="728x90/next.gif" /></a>
    </div>
        ...
        <div class="widget">
            ...
            <div class="leftcol">
		        ...
		        <div class="goArrowButton">
			        <a href="<?php echo(GetLink($product['deeplink']));?>"><img src="728x90/goArrowButton.jpg" alt="goArrowButton" width="27" height="84" /></a>
		        </div>
            </div>
		<?php 
			 $product = $products->getNext();
            ...
            <div class="righcol">
	            <div class="logo">
		            <a href="<?php echo(GetLink($product['deeplink']));?>">
		                <img src="728x90/LivingSocial_logo.png" alt="LivingSocial_logo" width="51" height="20">
		            </a>
	            </div>
