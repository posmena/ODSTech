...
$collection->insert(array('Agent' => $_SERVER['HTTP_USER_AGENT'], 'IP' => $_SERVER['REMOTE_ADDR'], 'date' => $mongotime, 'alias' => $_GET['alias'], 'guid' => $_GET['guid'], 'amount' => $amt, 'old_balance' => $startBal, 'new_balance' => $newBal, 'site' => $_GET['site']));
