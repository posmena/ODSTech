...
<form id="frm_odst_hilton" target="_blank" method="POST" action="http://www.awin1.com/awclick.php?awinmid=3624&awinaffid=<?php echo($affiliate_id)?>&clickref=<?php echo($campaign_id)?>&p=http://www3.hilton.com/en_US/hi/search/findhotels/index.htm">
	...
	<table class="odst" width="120" height="600" border="0" cellpadding="8" cellspacing="0"  >
		...
		<tr>
			<td align="left" valign="middle" background="images/120x600back.jpg" style="padding:10px">
					...
					<div id='messages' style=" position: absolute; top: 50px; left: 10px; width: 100px; height; 200px; text-align: center; color: #2f51a8; text-transform: uppercase;  margin-top: 10px;">
					<div id='div1' class=''> 
				...
				<table class="odst" border="0" table="table" width="100" height="270" cellspacing="0" cellpadding="0" class="vstyle" style="margin-top: 250px; display: BLOCK;">
					...
					<tr>
						<td>
							...
							<span class="odt_spanTextInput">
								<label class="labelOneBoxHint" for="hotelSearchOneBox" style="display:BLOCK; font-family: Arial;" >City, address...</label>
