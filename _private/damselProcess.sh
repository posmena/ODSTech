...
mongoexport -d odstech -c damsel_scrape --csv -f 'id','title','link','price','category','image_link','thumbnail','sizes','brand','availability','delivery_time','delivery_cost','material','description' -o files/hostedfeeds/damsel/webgains.csv | mail -s "Webgains Damsel Exported" tech@odst.co.uk < logs/damsel.log
