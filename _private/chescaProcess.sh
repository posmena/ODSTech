...
mongoexport -d odstech -c chesca_scrape --csv -f 'id','title','link','price','category','image_link','thumbnail','sizes','full_merchant_price','brand','availability','delivery_time','delivery_cost','material','description' -o files/hostedfeeds/chesca/webgains.csv | mail -s "Chesca Webgains Exported" tech@odst.co.uk < logs/chesca.log
