...
mongoexport -d odstech -c live_forthillhome --csv -f 'id','title','link','price','description','condition','image_thumbnail','category','quantity','availability','google_deeplink','google_product_type' -o files/hostedfeeds/forthill/froogle.csv | mail -s "Froogle Forthill Exported" tech@odst.co.uk < logs/forthill.log

echo 'http://www.odst.co.uk/feeds/forthill.zip?type=nextag' > logs/forthill.log
mongoexport -d odstech -c live_forthillhome --csv -f 'productid','productname','price','description','availability','category','condition','manufacturer','features','deeplink','image_thumbnail','image_large','nextag_deeplink' -o files/hostedfeeds/forthill/nextag.csv | mail -s "Nextag Forthill Exported" tech@odst.co.uk < logs/forthill.log

echo 'http://www.odst.co.uk/feeds/forthill.zip?type=dooyoo' > logs/forthill.log
mongoexport -d odstech -c live_forthillhome --csv -f 'productid','productname','price','description','availability','category','condition','manufacturer','features','deeplink','image_thumbnail','image_large','dooyoo_deeplink' -o files/hostedfeeds/forthill/dooyoo.csv | mail -s "Dooyoo Forthill Exported" tech@odst.co.uk < logs/forthill.log

echo 'http://www.odst.co.uk/feeds/forthill.zip?type=bing' > logs/forthill.log
mongoexport -d odstech -c live_forthillhome --csv -f 'productid','productname','price','description','availability','category','condition','manufacturer','features','deeplink','image_thumbnail','image_large' -o files/hostedfeeds/forthill/bing.csv | mail -s "Bing Forthill Exported" tech@odst.co.uk < logs/forthill.log
