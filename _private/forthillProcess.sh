...
mongoexport -d odstech -c live_forthillhome --csv -f 'id','title','link','price','description','condition','image_link','category','quantity','availability','google_deeplink','google_product_type' -o files/hostedfeeds/forthill/froogle.csv | mail -s "Froogle Forthill Exported" tech@odst.co.uk < logs/forthill.log
