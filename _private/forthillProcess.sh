...
mongoexport -d odstech -c live_forthillhome --csv -f 'id','title','link','price','description','condition','image_thumbnail','category','quantity','availability','google_deeplink','google_product_type' -o files/hostedfeeds/forthillhome/froogle.csv | mail -s "Forthill Froogle Exported" tech@odst.co.uk < logs/forthill.log
