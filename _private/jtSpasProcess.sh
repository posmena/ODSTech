...
php scripts/processFeed.php jtspas full | mail -s 'JtSpas Processed' tech@odst.co.uk
...
mongoexport -d odstech -c dump_jtspas --csv -f 'id','title','deeplink','price','description','condition','shipping','shipping_weight','gtin','brand','mpn','image_link','category','quantity','availability','expiration_date','webgains_category','shipping_uk','shipping_cost_uk' -o files/hostedfeeds/jtspas/all.csv | mail -s "JtSpas All Exported" tech@odst.co.uk < logs/jtspatype.log
...
mongoexport -d odstech -c dump_jtspas --csv -f 'id','title','link','price','description','condition','shipping_cost_uk','shipping_weight','gtin','brand','mpn','image_link','google_product_category','product_type','quantity','availability','expiration_date' -o files/hostedfeeds/jtspas/froogle.csv | mail -s "JtSpas Froogle Exported" tech@odst.co.uk < logs/jtspatype.log
...
mongoexport -d odstech -c dump_jtspas --csv -f 'category','id','title','price','deeplink','description','image_link','warranty','shipping','shipping_weight','shipping_uk','shipping_cost_uk','availability','condition','gtin','brand','dooyoo_deeplink','rrp' -o files/hostedfeeds/jtspas/dooyoo.csv | mail -s "JtSpas Dooyoo Exported" tech@odst.co.uk < logs/jtspatype.log

echo 'http://www.odst.co.uk/feeds/jtspas.zip?type=bing' > logs/jtspatype.log
mongoexport -d odstech -c dump_jtspas --csv -f 'id','title','price','description','condition','shipping','shipping_weight','shipping_uk','shipping_cost_uk','brand','mpn','image_link','category','quantity','availability','expiration_date','deeplink','rrp' -o files/hostedfeeds/jtspas/bing.csv | mail -s "JtSpas Bing Exported" tech@odst.co.uk < logs/jtspatype.log
