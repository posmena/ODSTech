...
mongoexport -d odstech -c live_jtspas --csv -f 'id','title','link','price','description','condition','shipping_cost_uk','shipping_weight','gtin','brand','mpn','image_link','category','quantity','availability' -o files/hostedfeeds/jtspas/froogle.csv | mail -s "JtSpas Froogle Exported" tech@odst.co.uk < logs/jtspatype.log
