...
mongoexport -d odstech -c live_jtspas --csv -f 'id','title','deeplink','price','description','condition','shipping','shipping_weight','gtin','brand','mpn','image_link','category','quantity','availability','expiration_date','webgains_category','shipping_uk','shipping_cost_uk' -o files/hostedfeeds/jtspas/all.csv | mail -s "All JtSpas Exported" tech@odst.co.uk < logs/jtspatype.log
...
mongoexport -d odstech -c live_jtspas --csv -f 'id','title','link','price','description','condition','shipping_cost_uk','shipping_weight','gtin','brand','mpn','image_link','category','quantity','availability','expiration_date' -o files/hostedfeeds/jtspas/froogle.csv | mail -s "Froogle JtSpas Exported" tech@odst.co.uk < logs/jtspatype.log
...
mongoexport -d odstech -c live_jtspas --csv -f 'id','title','price','description','condition','shipping','shipping_weight','shipping_uk','shipping_cost_uk','brand','mpn','image_link','category','quantity','availability','expiration_date','deeplink','rrp' -o files/hostedfeeds/jtspas/bing.csv | mail -s "Bing JtSpas Exported" tech@odst.co.uk < logs/jtspatype.log
