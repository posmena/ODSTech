...
cp files/hostedfeeds/easylife/custom.csv files/hostedfeeds/easylife/customCP.csv
printf '\xFF\xFE' > files/hostedfeeds/easylife/custom.csv
cat files/hostedfeeds/easylife/customCP.csv >> files/hostedfeeds/easylife/custom.csv
rm files/hostedfeeds/easylife/customCP.csv
