...
echo 'http://www.odst.co.uk/feeds/jtspas.zip?type=all' > logs/benchuk.log
mongoexport -d odstech -c dump_bench --csv -f 'id','title','link','price','sale_price','color','sizes','description','condition','shipping_cost_uk','brand','image_link','additional_image_link','category' -o files/hostedfeeds/benchuk/all.csv
